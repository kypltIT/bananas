            ...
            <ul class="flex flex-column h-full has-divider-line">
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-1.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">Neptune Longsleeve</a>
                            </div>
                ...
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-2.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">Ribbed Tank Top</a>
                            </div>
                ...
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-3.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">Ribbed modal T-shirt</a>
                            </div>
                ...
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-4.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">Oversized Motif T-shirt</a>
                            </div>
                ...
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-5.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">V-neck linen T-shirt</a>
                            </div>
                ...
                <li class="wg-product">
                    <div class="name flex-grow">
                        <div class="image">
                            <img src="admin-assets/images/products/product-6.jpg" alt="">
                        </div>
                        <div>
                            <div class="title">
                                <a href="index.html#" class="body-text">Jersey thong body</a>
                            </div>
    ...
    <div class="wg-box">
        ...
        <div class="wg-table table-recent-orders">
            ...
            <ul class="flex flex-column has-divider-line has-line-bot">
                ...
                <li class="item wg-product gap20">
                    <div class="name">
                        <div class="image">
                            <img src="admin-assets/images/products/product-7.jpg" alt="">
                        </div>
                        <div class="title mb-0">
                            <a href="index.html#" class="body-text">Oversized Motif T-shirt</a>
                        </div>
                ...
                <li class="item wg-product gap20">
                    <div class="name">
                        <div class="image">
                            <img src="admin-assets/admin-assets/images/products/product-4.jpg" alt="">
                        </div>
                        <div class="title mb-0">
                            <a href="index.html#" class="body-text">Oversized Motif T-shirt</a>
                        </div>
        ...
        <div class="flex items-center justify-between flex-wrap gap10">
            ...
            <ul class="wg-pagination">
                ...
                <li>
                    <a href="index.html#"><i class="icon-chevron-right"></i></a>
                </li>
            </ul>
        </div>
    </div>
