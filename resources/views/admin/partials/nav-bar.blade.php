                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton1" >
                            ...
                            <div class="noti-item w-full wg-user active">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                                        <a href="index.html#" class="body-title">Cameron Williamson</a>
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                                        <a href="index.html#" class="body-title">Ralph Edwards</a>
                                        <div class="time">10:13 PM</div>
                                    </div>
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                                        <a href="index.html#" class="body-title">Eleanor Pena</a>
                                        <div class="time">10:13 PM</div>
                                    </div>
                        ...
                        <li>
                            <div class="noti-item w-full wg-user active">
                                ...
                                <div class="flex-grow">
                                    <div class="flex items-center justify-between">
                                        <a href="index.html#" class="body-title">Jane Cooper</a>
                                        <div class="time">10:13 PM</div>
                                    </div>
                        ...
                        <li><a href="index.html#" class="tf-button w-full">View all</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="popup-wrap apps type-header">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton4" >
                        ...
                        <li><a href="index.html#" class="tf-button w-full">View all app</a></li>
                    </ul>
                </div>
            </div>
            <div class="popup-wrap user type-header">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end has-content" aria-labelledby="dropdownMenuButton3" >
                        <li>
                            <a href="index.html#" class="user-item">
                                <div class="icon">
                                    <i class="icon-user"></i>
                                </div>
