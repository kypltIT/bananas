...
<div id="wrapper">
    ...
    <div class="tf-toolbar-bottom type-1150">
        <div class="toolbar-item">
            <a href="home-sneaker.html#toolbarShopmb" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
        ...
        <div class="toolbar-item">
            <a href="home-sneaker.html#canvasSearch" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                <div class="toolbar-icon">
        ...
        <div class="toolbar-item">
            <a href="home-sneaker.html#login" data-bs-toggle="modal">
                <div class="toolbar-icon">
        ...
        <div class="toolbar-item">
            <a href="home-sneaker.html#shoppingCart" data-bs-toggle="modal">
                <div class="toolbar-icon">
                    <i class="icon-bag"></i>
            ...
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-one" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-one">
                            <span>Home</span>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-two" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-two">
                            <span>Shop</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-two" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li><a href="home-sneaker.html#sub-shop-one" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-one">
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-shop-two" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-two">
                                        <span>Features</span>
                                        <span class="btn-open-sub"></span>
                                    </a>
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-shop-three" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-three">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-three" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-three">
                            <span>Products</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-three" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li>
                                    <a href="home-sneaker.html#sub-product-one" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-one">
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-two" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-two">
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-three" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-three">
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-four" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-product-four">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-four" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-four">
                            <span>Pages</span>
                            <span class="btn-open-sub"></span>
                        </a>
                        <div id="dropdown-menu-four" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                ...
                                <li><a href="home-sneaker.html#sub-account" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-account">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-five" class="collapsed mb-menu-link current" data-bs-toggle="collapse" aria-expanded="true" aria-controls="dropdown-menu-five">
                            <span>Blog</span>
                            <span class="btn-open-sub"></span>
                        </a>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#" class="mb-menu-link">Buy now</a>
                    </li>
                </ul>
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                            <div class="image">
                        ...
                        <div id="cate-menu-one" class="collapse list-cate">
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="home-sneaker.html#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                        <div class="image">
                                ...
                                <li>
                                    <a href="home-sneaker.html#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                        <div class="image">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-two" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-two">
                            <div class="image">
                                <img src="images/shop/cate/cate6.jpg" alt="">
                            </div>
                            <span>Men</span>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-three" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-three">
                            <div class="image">
                                <img src="images/shop/cate/cate9.jpg" alt="">
                            </div>
                            <span>Women</span>
        ...
        <div class="modal-content">
            ...
            <div class="tf-login-form">
                <form class="" action="my-account.html" accept-charset="utf-8">
                    ...
                    <div>
                        <a href="home-sneaker.html#forgotPassword" data-bs-toggle="modal" class="btn-link link">Forgot your password?</a>
                    </div>
                    <div class="bottom"> 
                        <div class="w-100">
                        ...
                        <div class="w-100">
                            <a href="home-sneaker.html#register" data-bs-toggle="modal" class="btn-link fw-6 w-100 link">
        ...
        <div class="modal-content">
            ...
            <div class="tf-login-form">
                <form class="">
                    ...
                    <div>
                        <a href="home-sneaker.html#login" data-bs-toggle="modal" class="btn-link link">Cancel</a>
                    </div>
                    <div class="bottom"> 
                        <div class="w-100">
            ...
            <div class="tf-login-form">
                <form class="">
                    ...
                    <div class="bottom"> 
                        ...
                        <div class="w-100">
                            <a href="home-sneaker.html#login" data-bs-toggle="modal" class="btn-link fw-6 w-100 link">
        ...
        <div class="modal-content">
            ...
            <div class="tf-login-form">
                ...
                <div class="w-100 d-flex justify-content-center mt-3">
                    <a href="{{ route('auth.google') }}" class="tf-btn btn-fill animate-hover-btn radius-3 w-100 d-flex align-items-center justify-content-center">
                    ...
                    <div class="tf-mini-cart-wrap">
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-cart-tax"><strong>Shipping</strong> calculated at checkout</div>
                                ...
                                <div class="tf-cart-checkbox">
                                    ...
                                    <label for="CartDrawer-Form_agree">
                                        I agree with the 
                                        <a href="home-sneaker.html#" title="Terms of Service">terms and conditions</a>
                                    </label>
                                </div>
                                <div class="tf-mini-cart-view-checkout">
                                    <a href="{{ route('view.cart') }}" class="tf-btn btn-outline radius-3 link w-100 justify-content-center">View cart</a>
                ...
                <div class="wrap">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form>
                            ...
                            <a href="home-sneaker.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-product-btn-wishlist box-icon bg_white compare btn-icon-action">
                                <span class="icon icon-compare"></span>
                                <span class="icon icon-check"></span>
                            </a>
                            <div class="w-100">
                                <a href="home-sneaker.html#" class="btns-full">Buy with <img src="images/payments/paypal.png" alt=""></a>
                                <a href="home-sneaker.html#" class="payment-more-option">More payment options</a>
                            </div>
                        </form>
                    </div>
                </div>
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <a href="home-sneaker.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="tf-product-btn-wishlist hover-tooltip box-icon bg_white compare btn-icon-action">
                                        <span class="icon icon-compare"></span>
