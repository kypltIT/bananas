            ...
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-one" class="collapsed mb-menu-link current"
                        ...
                        <div id="dropdown-menu-one" class="collapse">
                            <ul class="sub-nav-menu">
                                ...
                                <li><a href="home-personalized-pod.html" class="sub-nav-link">Home Personalized
                                        Pod</a></li>
                                ...
                                <li><a href="home-gaming-accessories.html" class="sub-nav-link">Home Gaming
                                        Accessories</a></li>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-two" class="collapsed mb-menu-link current"
                        ...
                        <div id="dropdown-menu-two" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li><a href="home-sneaker.html#sub-shop-one" class="sub-nav-link collapsed"
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-shop-two" class="sub-nav-link collapsed"
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-shop-three" class="sub-nav-link collapsed"
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-three" class="collapsed mb-menu-link current"
                        ...
                        <div id="dropdown-menu-three" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                <li>
                                    <a href="home-sneaker.html#sub-product-one" class="sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true"
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-two" class="sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true"
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-three" class="sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true"
                                ...
                                <li>
                                    <a href="home-sneaker.html#sub-product-four" class="sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true"
                                    ...
                                    <div id="sub-product-four" class="collapse">
                                        <ul class="sub-nav-menu sub-menu-level-2">
                                            ...
                                            <li><a href="product-detail-buyx-gety.html"
                                                    class="sub-nav-link line-clamp">Buy X Get Y<div
                                                        class="demo-label"><span class="demo-new">New</span></div></a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-four" class="collapsed mb-menu-link current"
                        ...
                        <div id="dropdown-menu-four" class="collapse">
                            <ul class="sub-nav-menu" id="sub-menu-navigation">
                                ...
                                <li><a href="home-sneaker.html#sub-account" class="sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-account">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#dropdown-menu-five" class="collapsed mb-menu-link current"
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-one"
                        ...
                        <div id="cate-menu-one" class="collapse list-cate">
                            <ul class="sub-nav-menu" id="cate-menu-navigation">
                                <li>
                                    <a href="home-sneaker.html#cate-shop-one"
                                ...
                                <li>
                                    <a href="home-sneaker.html#cate-shop-two"
                                        class="tf-category-link has-children sub-nav-link collapsed"
                                        data-bs-toggle="collapse" aria-expanded="true"
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-two"
                            class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse"
                    ...
                    <li class="nav-mb-item">
                        <a href="home-sneaker.html#cate-menu-three"
                            class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse"
            ...
            <div class="modal-content">
                ...
                <div class="tf-login-form">
                    <form class="" action="my-account.html" accept-charset="utf-8">
                        ...
                        <div>
                            <a href="home-sneaker.html#forgotPassword" data-bs-toggle="modal"
                        ...
                        <div class="bottom">
                            ...
                            <div class="w-100">
                                <a href="home-sneaker.html#register" data-bs-toggle="modal"
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                ...
                                <div class="tf-cart-checkbox">
                                    ...
                                    <label for="CartDrawer-Form_agree">
                                        I agree with the
                                        <a href="home-sneaker.html#" title="Terms of Service">terms and
                                            conditions</a>
                                    </label>
                                </div>
                ...
                <div class="wrap">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form>
                            ...
                            <a href="home-sneaker.html#compare" data-bs-toggle="offcanvas"
                            ...
                            <div class="w-100">
                                <a href="home-sneaker.html#" class="btns-full">Buy with <img
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <div class="w-100">
                                        <a href="home-sneaker.html#" class="btns-full">Buy with <img
                                                src="images/payments/paypal.png" alt=""></a>
                                        <a href="home-sneaker.html#" class="payment-more-option">More payment
                                            options</a>
                                    </div>
                                </form>
                            </div>
