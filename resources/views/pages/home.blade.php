                ...
                <div class="tf-grid-layout tf-col-2 gap30 row-gap-10">
                    <div class="card-product">
                        <div class="card-product-wrapper rounded-0">
                            ...
                            <div class="list-product-btn absolute-2">
                                <a href="home-sneaker.html#shoppingCart" data-bs-toggle="modal" class="box-icon quick-add tf-btn-loading">
                                    <span class="icon icon-bag"></span>
                                ...
                                <a href="home-sneaker.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon compare btn-icon-action">
                                    <span class="icon icon-compare"></span>
                                    <span class="tooltip">Add to Compare</span>
                                    <span class="icon icon-check"></span>
                                </a>
                                <a href="home-sneaker.html#quick_view" data-bs-toggle="modal" class="box-icon quickview tf-btn-loading">
                                    <span class="icon icon-view"></span>
                                    <span class="tooltip">Quick View</span>
                                </a>
                            </div>
