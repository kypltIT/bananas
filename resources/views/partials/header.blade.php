            ...
            <div class="px_15 lg-px_40">
                <div class="row wrapper-header align-items-center">
                    <div class="col-md-4 col-3 tf-lg-hidden">
                        <a href="home-sneaker.html#mobileMenu" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft">
                                                            ...
                                                            <div class="swiper-wrapper">
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <a href="home-sneaker.html#" class="product-img">
                                                                            ...
                                                                            <div class="list-product-btn absolute-2">
                                                                                <a href="home-sneaker.html#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                ...
                                                                                <a href="home-sneaker.html#compare" data-bs-toggle="offcanvas" aria-controls="offcanvasLeft" class="box-icon bg_white compare btn-icon-action">
                                                                                    <span class="icon icon-compare"></span>
                                                                                    <span class="tooltip">Add to Compare</span>
                                                                                    <span class="icon icon-check"></span>
                                                                                </a>
                                                                                <a href="home-sneaker.html#quick_view" data-bs-toggle="modal" class="box-icon bg_white quickview tf-btn-loading">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-sneaker.html#" class="title link">Ribbed Tank Top</a>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            ...
                                                                            <div class="list-product-btn absolute-2">
                                                                                <a href="home-sneaker.html#shoppingCart" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                                                                    <span class="icon icon-bag"></span>
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-sneaker.html#" class="title link">Oversized Printed T-shirt</a>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-sneaker.html#" class="title">Oversized Printed T-shirt</a>
                                                                            <span class="price">$16.95</span>
                                                                            <ul class="list-color-product">
                                                                                <li class="list-color-item color-swatch active">
                                                                                    <span class="tooltip">White</span>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            <a href="home-sneaker.html#" class="title link">V-neck linen T-shirt</a>
